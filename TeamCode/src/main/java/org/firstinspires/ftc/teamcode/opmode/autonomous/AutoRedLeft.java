...
public class AutoRedLeft extends LinearOpMode {
    ...
    private void movement() {
        ...
        drive(9);//move forrward right before the barcode
        delay(1);
        turn(-90);
        delay(1);
        drive(13);//turn and move to before the wall
        delay(1);
        turn(90);
        delay(0.5);
        ...
        turn(-90);
        delay(.5);
        drive(10, .5);//flaten against wall
        delay(0.5);
        drive(-27.5, 1);//turn and move to shipping hub
        depositBlock();
        delay(2);
        drive(26);
        robot.reset();
    ...
    private void depositBlock()
    {
        ...
        if (zone == 1) {
            ...
            robot.slider.setTargetPosition(PositionFields.MIDDLE + 50);
            robot.slider.setMode(DcMotor.RunMode.RUN_TO_POSITION);
            robot.slider.setPower(1);
            delay(2);
        } else {
