...
//        else currentOrientation += deg;
        ...
        // While
            ...
            while (imuTime.seconds() < timeoutS && currentError > 0 + PIDFields.marginOfError ) {
                ...
                telemetry.addLine("Time: " + imuTime.seconds() + " vs. TimeOut:" + timeoutS);
                telemetry.addLine("Imu Power: " + power);
                telemetry.addLine("inptu: " + (currentError - previousError));


                telemetry.addLine("currentError: " + currentError);
                telemetry.addLine("previouserror: " + previousError);

                telemetry.addLine("Orientation: " + getCurrentOrientation());
                telemetry.addLine("goal:" + imuTarget);
                telemetry.update();
